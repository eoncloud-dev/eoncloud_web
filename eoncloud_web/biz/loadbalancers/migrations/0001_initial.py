    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('http_method', models.CharField(max_length=10, null=True, verbose_name='http_method', blank=True)),
                ('url_path', models.CharField(max_length=10, null=True, verbose_name='url_path', blank=True)),
                ('expected_codes', models.CharField(max_length=128, null=True, verbose_name='expected_codes', blank=True)),
                ('admin_state_up', models.BooleanField(default=True, verbose_name='admin state up', choices=[(True, b'UP'), (False, b'DOWN')])),
                ('create_date', models.DateTimeField(auto_now_add=True, verbose_name='Create Date')),
                ('deleted', models.BooleanField(default=False, verbose_name='Deleted')),

...
class BalancerMonitor(models.Model):
    ...
    http_method = models.CharField(_("http_method"), null=True, blank=True, max_length=10)
    url_path = models.CharField(_("url_path"), null=True, blank=True, max_length=10)
    expected_codes = models.CharField(_("expected_codes"), null=True, blank=True, max_length=128)
    admin_state_up = models.BooleanField(_("admin state up"), default=True, choices=ADMIN_STATE_UP)

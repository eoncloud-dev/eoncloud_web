...
MONITOR_CONFIG = {
    ...
    'URLS': {
        ...
        "NETWORK": "/#/visualize/edit/instance.network?embed&&_a=(filters:!(),linked:!f,query:(query_string:(analyze_wildcard:!t,query:'resource_id:{[{ uuid }]}!'')),vis:(aggs:!((id:'1',params:(field:network.incoming.bytes.rate),schema:metric,type:avg),(id:'2',params:(extended_bounds:(),field:'@timestamp',interval:{[{ interval }]},min_doc_count:1),schema:segment,type:date_histogram),(id:'3',params:(field:network.outgoing.bytes.rate),schema:metric,type:avg)),listeners:(),params:(addLegend:!t,addTooltip:!t,defaultYExtents:!f,shareYAxis:!t),type:line))",
